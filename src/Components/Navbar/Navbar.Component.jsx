...
function NavSm() {
  return <>
    <div className="text-white flex item-centre justify-between mx-3 py-2">
      <div>
      ...
      <div className="w-1/3 h-8 flex item-centre my-auto">
        <button className='bg-red-400 w-full h-full rounded-md '>Sign In</button>
